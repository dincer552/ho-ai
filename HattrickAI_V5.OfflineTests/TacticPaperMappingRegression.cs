...
public static class TacticPaperMappingRegression
{
    public static int Run()
    {
        ...
        // The calibrated high-level AoW allocation is ~70.10%; keep a narrow tolerance around the observed calibrated value.
        AssertSectorEnvelope(AdvancedTactic.AttackWings, 10, 0.69, 0.71, "AoW high-level wing share");
