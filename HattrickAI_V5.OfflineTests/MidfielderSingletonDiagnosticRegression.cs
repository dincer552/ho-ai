...
public static class MidfielderSingletonDiagnosticRegression
{
    public static int Run()
    {
        ...
        // Current 2026-09-19 user-supplied 0-1-0 normal IM-C screenshots.
        // White displayed values are ground truth; green deltas are ignored.
        // Sector order: LD, CD, RD, MID, LA, CA, RA.
        var fixtures = new[]
        {
            new Fixture("Patrik Zarins", 498557618, 4, 6, 8, 2, 12, 6, 2, 7, 1, 1.25, 1, 1.50, 1, 1.75, 1),
            new Fixture("Cristian Pesalovo", 476114406, 16, 6, 9, 3, 6, 7, 6, 7, 1.25, 2.00, 1.25, 1.50, 1, 1.75, 1),
            ...
            new Fixture("Mikel Thiebault", 498487535, 4, 5, 9, 4, 12, 6, 2, 8, 1, 1.25, 1, 1.25, 1, 2.00, 1)
        };
