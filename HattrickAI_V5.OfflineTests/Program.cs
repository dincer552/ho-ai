...
if (args.Length > 0 && string.Equals(args[0], "real-hattrick-rating", StringComparison.OrdinalIgnoreCase))
    return RealHattrickLineupRatingRegression.Run();
...
if (args.Length > 0 && string.Equals(args[0], "screenshot-451", StringComparison.OrdinalIgnoreCase))
    return Screenshot451Diagnostic.Run();
